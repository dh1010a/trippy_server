...
//				.requestMatchers(toH2Console())
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http	.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers( "/api/email/send", "/api/member/password", "/api/email/confirm", "/api/member/find", "/api/recommend/interest", "/api/recommend/spot").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList(corsProperties.getAllowedOrigins(), "http://localhost:3000", "https://trippy-api.store", "https://trippy-front.vercel.app"));
