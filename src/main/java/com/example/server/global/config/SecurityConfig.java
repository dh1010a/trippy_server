    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http	.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers( "/api/email/send", "/api/member/password", "/api/email/confirm", "/api/member/find", "/api/member/delete", "/api/member/{nickName}", "/api/post/all/count").permitAll()
                        .requestMatchers("/api/post/all", "/api/ootd/all").permitAll()
